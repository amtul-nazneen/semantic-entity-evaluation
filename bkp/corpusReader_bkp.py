...
def corpusReader_bkp():
    ...
    with open(TRAINING_FILE_NAME, 'r') as file:
        ...
        for para in paragraphs:
            ...
            # quoted_2 = re.compile('"[\d\D\w\W\s]+\n')
            onlyquoted = quoted.findall(para)
            # printConsole(onlyquoted)
            if (onlyquoted):
                ...
                if (not sentences[1].strip().lower().startswith('other')):  # != "other"):
                    print(sentences[1])
                ...
                # processedParaList[4] = relation_direction
                    ...
                    relation_name = sentences[1].strip()
                    # assumption in case of other relation direction is 0
                    relation_direction = 0
                ##--change1----
